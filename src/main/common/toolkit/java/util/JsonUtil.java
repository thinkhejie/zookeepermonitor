...
public class JsonUtil {
	...
	public static String checkJsonContent(String originalStr) {
		...
		if (-1 == originalStr.indexOf(SymbolConstant.SQUARE_BRACKETS_LEFT) || -1 == originalStr.indexOf(SymbolConstant.SQUARE_BRACKETS_RIGHT)
				|| originalStr.indexOf(SymbolConstant.SQUARE_BRACKETS_LEFT) >= originalStr.indexOf(SymbolConstant.SQUARE_BRACKETS_RIGHT))
			return EmptyObjectConstant.EMPTY_STRING;

...
public class HostPerformanceEntity {
	...
	public String toString() {
		return "SystemPerformanceEntity[ ip: " + this.ip + ", cpuUsage: " + this.cpuUsage + ", memoryUsage: " + this.memoryUsage + ", load: " + this.load + ", diskUsage: " + diskUsageMap + "]";
	}
